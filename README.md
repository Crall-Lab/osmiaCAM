This README is for osmiaCAM, a low-cost imaging monitoring system for linking solitary bee foraging, nest provisioning, and environmental sensitivity. `analysis` contains automated analysis scripts currently underdevelopment, and `build` contains laser cutting files associated with this system.

Code used for proof of concept, associated with a manuscript under preparation, is avaliable [here]().

Below are the build instructions for osmiaCAM.
